...
3. Реализуйте логику трех protected методов в ThisUncaughtExceptionHandler используя
вызовы соответствующих методов согласно следующему шаблону:
...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        try {
            ...
            current = string.substring(firstIndex, lastIndex);
        } catch (Exception e) {
