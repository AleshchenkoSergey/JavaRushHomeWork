...
public class AdvertisementManager {
    ...
    public void processVideos() throws NoVideoAvailableException {
        ...
        // лист маска для исходного листа (по нему мы включаем или
        // нет в результат элементы исходного 1 - да, 0 - нет)
        ...
        //2.6 Для каждого показанного рекламного ролика пересчитать
        // его данные вызвав метод revalidate() у объекта класса Advertisement.
